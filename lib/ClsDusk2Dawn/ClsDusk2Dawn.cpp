 ...
 *  <https://github.com/dmkishi/ClsDusk2Dawn>
 */
 ...
 */
ClsDusk2Dawn::ClsDusk2Dawn(float latitude, float longitude, float timezone) {
  _latitude  = latitude;
...
int ClsDusk2Dawn::sunrise(int y, int m, int d, bool isDST) {
  return sunriseSet(true, y, m, d, isDST);
}


int ClsDusk2Dawn::sunset(int y, int m, int d, bool isDST) {
 ...
 */
bool ClsDusk2Dawn::min2str(char *str, int minutes) {
  bool isError = false;
...
/*                                  PRIVATE                                   */
/******************************************************************************/
int ClsDusk2Dawn::sunriseSet(bool isRise, int y, int m, int d, bool isDST) {
...
float ClsDusk2Dawn::sunriseSetUTC(bool isRise, float jday, float latitude, float longitude) {
 ...
 */
float ClsDusk2Dawn::equationOfTime(float t) {
 ...
 */
float ClsDusk2Dawn::meanObliquityOfEcliptic(float t) {
...
float ClsDusk2Dawn::eccentricityEarthOrbit(float t) {
...
/* --------------------------- SOLAR DECLINATION ---------------------------- */
float ClsDusk2Dawn::sunDeclination(float t) {
...
float ClsDusk2Dawn::sunApparentLong(float t) {
...
float ClsDusk2Dawn::sunTrueLong(float t) {
  float l0 = geomMeanLongSun(t);
...
float ClsDusk2Dawn::sunEqOfCenter(float t) {
  float m     = geomMeanAnomalySun(t);
...
/* ------------------------------- HOUR ANGLE ------------------------------- */
float ClsDusk2Dawn::hourAngleSunrise(float lat, float solarDec) {
...
/* ---------------------------- SHARED FUNCTIONS ---------------------------- */
float ClsDusk2Dawn::obliquityCorrection(float t) {
...
float ClsDusk2Dawn::geomMeanLongSun(float t) {
...
float ClsDusk2Dawn::geomMeanAnomalySun(float t) {
 ...
 */
float ClsDusk2Dawn::jDay(int year, int month, int day) {
  if (month <= 2) {
    year  -= 1;
    month += 12;
  }
 ...
 */
float ClsDusk2Dawn::fractionOfCentury(float jd) {
  return (jd - 2451545) / 36525;
}


float ClsDusk2Dawn::radToDeg(float rad) {
  return 180 * rad / PI;
}


float ClsDusk2Dawn::degToRad(float deg) {
  return PI * deg / 180;
}
 ...
 */
bool ClsDusk2Dawn::zeroPadTime(char *str, byte timeComponent) {
