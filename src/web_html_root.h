...
<div id="divbody">
  ...
  <div class="row menu">
   ...
   <input type="button" class="button orange" onclick="getRelay(2);" value="Pipe 3">
   <input type="button" class="button orange" onclick="getRelay(3);" value="Pipe 4">
   <input type="button" class="button orange" onclick="getRelay(4);" value="Pipe 5">
  </p><hr>
  <div class="row">
    <div id="divContent">
